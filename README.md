...
Checked here: all seventeen apply cleanly, in this exact order, on the unpatched Debian source (fresh extraction, tested end to end). Not checked here: compiling (that is what the GitHub build does) or hearing/using any of it (that is what the Pi does).
